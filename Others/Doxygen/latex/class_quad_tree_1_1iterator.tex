...
\hypertarget{class_quad_tree_1_1iterator_a73eef33266569624d3993667207d5b33}{\index{Quad\-Tree\-::iterator@{Quad\-Tree\-::iterator}!operator==@{operator==}}
\index{operator==@{operator==}!QuadTree::iterator@{Quad\-Tree\-::iterator}}
\subsubsection[{operator==}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T$>$ bool {\bf Quad\-Tree}$<$ T $>$\-::iterator\-::operator== (
\begin{DoxyParamCaption}
\item[{const {\bf iterator} \&}]{iter}
...
Egyenlőség operátor \begin{DoxyReturn}{Visszatérési érték}
